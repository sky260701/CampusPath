    ...
    return (
        <div className="bg-bgpurple " id="first-section">
            <div className="mx-auto max-w-2xl  pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4'>
                        <img src={'/assets/logo/Logo.svg'} alt="logo" className='pb-4' />
                        <h3 className='text-white text-lg font-medium leading-9 mb-4 lg:mb-20'> Level up your College Search, and get dream <br /> College with CampusPath. </h3>
            ...
            <div className='pb-24 px-4'>
                <h3 className='text-center text-offwhite'>@2023 - All Rights Reserved by <Link href="/" target="_blank">CampusPath</Link></h3>
            </div>
